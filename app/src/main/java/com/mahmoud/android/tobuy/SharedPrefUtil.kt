...
object SharedPrefUtil {
    ...
    fun getHighPriorityColor(): Int = getInt(PREF_PRIORITY_HIGH)
    fun getMediumPriorityColor(): Int = getInt(PREF_PRIORITY_MEDIUM)
    fun getLowPriorityColor(): Int = getInt(PREF_PRIORITY_LOW)
